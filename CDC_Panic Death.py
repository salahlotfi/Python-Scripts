...
def main() :
    ...
    print("Total Whites with Emphysema: ",wpanic)
    print("Total Blacks with Emphysema: ",bpanic)
    print("Percent Whites with Emphysema: ",100*wpanic/wcount,"%")
    print("Percent Blacks with Emphysema: ",100*bpanic/bcount,"%")
